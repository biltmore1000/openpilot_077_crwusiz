...
_AWARENESS_TIME = 7000.  # one minute limit without user touching steering wheels make the car enter a terminal status ( 70 * 3 )
_AWARENESS_PRE_TIME_TILL_TERMINAL = 25.  # a first alert is issued 25s before expiration ( 15 to 25 )
_AWARENESS_PROMPT_TIME_TILL_TERMINAL = 15.  # a second alert is issued 15s before start decelerating the car ( 6 to 15 )
